...
- $x^{(1)} = 650$ and $y^{(1)}$ $=$ **_\$772,000_** represent the square footage and housing price of the first house, respectively.
- $x^{(2)} = 785$ and $y^{(2)}$ $=$ **_\$998,000_** represent the square footage and housing price of the second house, and so on.
